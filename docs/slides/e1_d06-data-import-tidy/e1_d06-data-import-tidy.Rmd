...
- Daten aus einem weiten Format in ein langes Format bringen, und umgekehrt
...
.pull-right[
**Daten für Daten Analyse bereitstellen**
- Layout (Tidy data)
- Eigenschaft 1: Jede Spalte ist eine Variable
- Eigenschaft 2: Jede Reihe ist eine Beobachtung
- Eigenschaft 3: Jede Zelle enthält eine Messung
...
```{r ref.label="treibhausgas1", echo=FALSE, warning=FALSE, out.width="100%"}
