...
subtitle: "Mit mehreren Dataframes arbeiten / Funktionen schreiben"
...
```{r, out.width="80%"}
knitr::include_graphics("img/github-to-project-local.004.png")
```
...
```{r, out.width="90%"}
knitr::include_graphics("img/github-to-project-local.005.png")
```
...
- **Bonusmaterial:** Eine eigene Funktion für ein `{ggplot2}` theme schreiben 
...
---
# Projektarbeit - Unterstützung im Februar 2022
