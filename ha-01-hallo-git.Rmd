...
# Verbindung zu GitHub und Posit Cloud aufbauen
...
Um deine Posit Cloud und GitHub Konten zu verbinden, befolge die folgenden Schritte:

- Öffne https://posit.cloud/ und login mit deinem Benutzerkonto (nutze GitHub)
...
- Zurück im Authentifizierungsfenster in Posit Cloud aktivierst du nun auch das Kästchen *Private repo access also enabled*
...
- Öffne nun Posit Cloud und den **Workspace rstatZH-k007** für den Kurs. Klicke auf den Abwärtspfeil und erstelle ein **New Project from Git Repository**.
...
- Im Posit Cloud Workspace für den Kurs, klicke auf "Projects"
...
In deiner RStudio IDE, öffne das Fenster mit dem Titel Git im Ansichtsfenster oben rechts.
