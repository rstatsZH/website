...
knitr::include_graphics(here::here("slides/screenshot-imgs/screenshot-imgs.002.jpeg"))
```

```{r, fig.fullwidth=TRUE, echo = FALSE}
knitr::include_graphics(here::here("slides/screenshot-imgs/screenshot-imgs.003.jpeg"))
```
