...
In Zukunft wird jede Aufgabe mit einem Abschnitt "Erste Schritte" beginnen, aber mit etwas weniger Details. Du kannst jedoch jederzeit auf dieses Heimarbeit zurückgreifen, um eine detaillierte Liste der Schritte zu erhalten, die notwendig sind, um mit einer Aufgabe zu beginnen.
...
- Auf GitHub klickst du auf den grünen **Code** und wählst **Use HTTPS** wie im Bild unten (dies könnte bereits standardmäßig ausgewählt sein, und wenn es so ist, siehst du den Text **Clone mit HTTPS**). Klicke auf das Klemmbrett-Symbol, um die Repo-URL zu kopieren.
