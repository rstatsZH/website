...
- RStudio IDE wird entwickelt von [Posit Software, PBC formerly RStudio, PBC](https://posit.co/) (Public Benefit Corporation), eine US-amerikanische Firma
]
...
- Mit Stand Februar 2023 gibt es mehr als 19'000 R-Pakate auf **CRAN** (dem Comprehensive R Archive Network)<sup>1</sup>
...
- Öffne posit.cloud und login (Link ist im Zoom Chat) 
...
- Öffne "Projects" in Posit Cloud Workspace
...
- .gray[R]
- .gray[RStudio IDE on Posit (Cloud)]
- .gray[tidyverse]
- .gray[R Markdown]
...
- Die Anweisungen für die Hausaufgabe 01 findet ihr oben rechts auf unserer Kurswebsite
...
Bitte ausfüllen: [https://forms.gle/YTy2R4hevrZXmgMN6](https://forms.gle/YTy2R4hevrZXmgMN6)
