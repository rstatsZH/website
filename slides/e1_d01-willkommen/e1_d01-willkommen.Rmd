...
klappt oder ihr eine Frage habt, dann habt bitte die Hand. Das könnt ihr unten
im Reaktionen Feld machen. Dies werde ich immer mal wieder auch für Feedback
von euch nutzen.
...
???
Falls ihr während des spezifische Fragen oder technische Probleme habt, schreibt
mich doch bitte auf Slack an. 

Dort ist es etwas einfacher für mich euch folgen
zu können und zu helfen. Ihr könnt es direkt in unseren Channel posten. Bei einer Error 
...
Als Zusammenfassung könnt seid ihr am Ende dieses Kurses ein moderner R Nutzer.
...
???
R gibt es schon eine ganze Weile 
...
- Die Anweisungen für die Heimarbeit 1 findet ihr oben rechts auf unserer Kurswebseite
