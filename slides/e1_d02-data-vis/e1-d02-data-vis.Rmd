...
- RStudio Cloud: https://rstudio.cloud/spaces/122222/projects
- Kurs Webseite: https://rstatszh.github.io/website/
- GitHub: https://github.com/rstatszh-k002
...
---
background-image: url(img/email-klick.jpeg)
background-size: contain 

---
background-image: url(img/screenshot.004.jpeg)
background-size: contain 

---
background-image: url(img/screenshot.005.jpeg)
background-size: contain 

---
background-image: url(img/screenshot.006.jpeg)
background-size: contain 

---
background-image: url(img/screenshot.007.jpeg)
background-size: contain 

---
background-image: url(img/screenshot.008.jpeg)
background-size: contain 
...
```{r ref.label = "penguins-scale", echo = FALSE, warning = FALSE, out.width = "80%", fig.width = 8}
```
