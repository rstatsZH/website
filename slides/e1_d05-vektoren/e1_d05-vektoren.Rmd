...
---
# Hausaufgabe 4 -  Übung 1

Was glaubst du wird mit der Zeile:  
...
Wenn Daten im UTF-8 Standard kodiert (gespeichert) wurden wir das `locale =` Argument nicht benötigt, da die Funktion `read_csv` standardmässig UTF-8 für die Dekodierung nutzt. 
...
**Tipp:** UTF-8 als Standard festlegen um Daten aus R zu speichern: https://github.com/rstatsZH/kochbuch/tree/main/06-file-encoding
