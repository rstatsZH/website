...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.001.png")
```

.xsmall[Quelle: [Bundesamt für Statistik - Ständige Wohnbevölkerung nach Altersklasse und Altersmasszahlen nach Kanton, Provisorische Jahresergebnisse, 2020]( https://www.bfs.admin.ch/bfs/de/home/statistiken/kataloge-datenbanken/tabellen.assetdetail.16404478.html)]
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.002.png")
```
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.003.png")
```
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.004.png")
```

.xsmall[Quelle: [Bundesamt für Statistik - Kosten des Gesundheitswesens nach Leistungen]( https://www.bfs.admin.ch/bfs/de/home/statistiken/kataloge-datenbanken/tabellen.assetdetail.14840808.html)]
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.005.png")
```
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.006.png")
```
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.007.png")
```

.xsmall[Quelle: [Bundesamt für Statistik - Klimadaten: Eistage, Frosttage, Sommertage, Hitzetage, Tropennächte und Niederschlagstage]( https://www.bfs.admin.ch/bfs/de/home/statistiken/kataloge-datenbanken/tabellen.assetdetail.15964164.html)]
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.008.png")
```
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.009.png")
```
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.010.png")
```
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.011.png")
```
...
```{r}
knitr::include_graphics("img/untidy-data/untidy-data.012.png")
```
